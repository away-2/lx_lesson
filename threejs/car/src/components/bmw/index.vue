<template>
    <div class="home">
        ...
        <div class="home-content">
            ...
            <h2>选择贴膜材质</h2>
            <div class="select">
                <div class="select-item" v-for="(item, index) in material" :key="index" @click="selectMaterial(index)">
...
const colors = ['red', 'green', 'blue', 'yellow', 'white', 'black', 'pink', 'purple']
const material = [
    { name: '磨砂', value: 1 },
    { name: '冰晶', value: 2 }
]
...
onMounted(() =>{
    ...
    const draocLoader = new DRACOLoader()
    draocLoader.setDecoderPath('./draco/gltf/')
    draocLoader.preload()
    loader.setDRACOLoader(draocLoader)
